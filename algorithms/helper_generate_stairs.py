...
from qgis.core import (
    ...
    QgsFillSymbol, QgsLinePatternFillSymbolLayer, QgsSimpleLineSymbolLayer,
    QgsSingleSymbolRenderer, QgsMapUnitScale
)
...
class GenerateStairsAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterNumber(
            ...
            QgsProcessingParameterNumber.Double, 0.3, minValue=0.15))
        self.addParameter(QgsProcessingParameterNumber(
            self.STAIR_COUNT,
            self.tr('Basamak Sayısı'),
            QgsProcessingParameterNumber.Integer, 10, minValue=1))
        self.addParameter(QgsProcessingParameterFeatureSink(
            self.OUTPUT, self.tr('Merdiven Sınırı')))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for i, feat in enumerate(source.getFeatures()):
            ...
            nf.setAttributes(['Merdiven', round(width, 2), round(total_length, 2), count])
    ...
    def postProcessAlgorithm(self, context, feedback):
        ...
        if layer:
            symbol = QgsFillSymbol.createSimple({'color': '200,200,200,100', 'outline_color': '50,50,50'})
    ...
    def shortHelpString(self):
        return self.tr("Bir çizgi veya poligon doğrultusunda 2 Boyutlu merdiven izdüşümü üretir.")
