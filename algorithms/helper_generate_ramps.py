...
class GenerateRampsAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(self.OUTPUT, self.tr("Rampa Sınırı"))
        )
    ...
    def postProcessAlgorithm(self, context, feedback):
        ...
        if layer:
            ...
            symbol = QgsFillSymbol.createSimple(
                {"color": "220,220,220,255", "outline_color": "50,50,50"}
            )
            gradient = QgsGradientFillSymbolLayer()
            gradient.setColor(
                QCoreApplication.translate("Processing", "150,150,150,255")
            )
            gradient.setColor2(
                QCoreApplication.translate("Processing", "240,240,240,255")
            )
    ...
    def shortHelpString(self):
        return self.tr(
            "Bir çizgi veya poligon doğrultusunda 2 Boyutlu rampa izdüşümü üretir."
        )
